          ...
          <div className="relative mx-auto max-w-4xl text-center">
            ...
            >
              ...
              <h1 className="text-4xl font-extrabold leading-tight tracking-tight text-white md:text-5xl lg:text-6xl">
                Automation Solutions That <GradientText>Actually Work</GradientText>
              </h1>
              <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-white/70 md:text-xl">
                From workflow automation to AI assistants, we build systems that eliminate busywork and let your team focus on what matters most.
              </p>
            </motion.div>
          </div>
        </section>
