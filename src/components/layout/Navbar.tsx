    ...
    <>
      <div className="fixed left-0 right-0 top-0 z-50 flex justify-center px-5 pt-5">
        <motion.nav
          ...
          className="relative flex w-full max-w-[980px] items-center overflow-hidden rounded-full border border-gray-200/60 bg-white/88 px-2.5 py-1.5 shadow-[0_4px_40px_rgba(0,0,0,0.06),0_0_0_1px_rgba(0,0,0,0.02)] backdrop-blur-2xl transition-all duration-500 lg:px-3 lg:py-2"
        >
          <AppLink href="#top" className="group flex shrink-0 items-center pl-3">
            <BrandMark />
          </AppLink>
